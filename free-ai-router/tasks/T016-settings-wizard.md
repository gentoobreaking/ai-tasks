...
- [ ] Inline API key editing with bullet/masked characters
- [ ] Live test ping for selected provider
- [ ] Auto-open signup page when navigating to a provider with no key
- [ ] First-run wizard (§6.12):
