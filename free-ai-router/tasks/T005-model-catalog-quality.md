...
## 驗收標準
- [ ] Model registry with aliasing and canonicalization (§15.4, §22.3)
- [ ] Quality scoring hierarchy (priority order):
  ...
  5. Default 0.45
- [ ] SWE-bench tier computation (S+ >=70%, S 60-70%, A+ 50-60%, A 40-50%, A- 35-40%, B+ 30-35%, B 20-30%, C <20%) (§4.3)
- [ ] `model-aliases.json` for URL-friendly alias resolution
- [ ] `models_test.go` with model aliasing, canonicalization, quality score resolution
