---
github_issue: N/A
title: 新增工具 get_insti_weekly（TAIFEX 三大法人依週別系列）
type: feature
priority: medium
status: done
depends_on: []
...
# T204 - 新增工具 get_insti_weekly（TAIFEX 三大法人依週別系列）

## 目標
查詢 TAIFEX 三大法人「依週別」部位資料（type 參數切換 general/fut_opt/fut_contracts/opt_contracts/calls_puts 五型）。現有法人工具僅日頻，週別適合波段判斷。
...
| 端點 | 說明 |
|---|---|
| `MarketDataOfMajorInstitutionalTradersGeneralBytheWeek` | 三大法人-總表-依週別 |
| `MarketDataOfMajorInstitutionalTradersDividedByFuturesAndOptionsBytheWeek` | 區分期貨與選擇權二類-依週別 |
| `MarketDataOfMajorInstitutionalTradersDetailsOfFuturesContractsBytheWeek` | 區分各期貨契約-依週別 |
| `MarketDataOfMajorInstitutionalTradersDetailsOfOptionsContractsBytheWeek` | 區分各選擇權契約-依週別 |
| `MarketDataOfMajorInstitutionalTradersDetailsOfCallsAndPutsBytheWeek` | 選擇權買賣權分計-依週別 |
