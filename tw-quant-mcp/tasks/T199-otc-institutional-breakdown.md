---
github_issue: N/A
title: 新增工具 get_otc_institutional_breakdown（上櫃投信/自營買賣超分項）
type: feature
priority: medium
status: pending
depends_on: []
...
# T199 - 新增工具 get_otc_institutional_breakdown（上櫃投信/自營買賣超分項）

## 目標
查詢上櫃投信、自營商（自行買賣/避險）每日買賣超彙總。kind 參數切換 trust/dealer；與既有上櫃合計工具互補。
