---
github_issue: N/A
title: 新增工具 get_taifex_block_trade（期交所鉅額交易系列）
type: feature
priority: medium
status: pending
depends_on: []
...
# T208 - 新增工具 get_taifex_block_trade（期交所鉅額交易系列）

## 目標
查詢 TAIFEX 鉅額交易成交與統計（kind 參數切換 all/futures/options/summary_futures/summary_options）。對稱 TWSE 鉅額交易系列（T042–T045）。
...
| 端點 | 說明 |
|---|---|
| `BlockTrade` | 鉅額交易各商品成交資訊 |
| `BTDailyTradeInformationFutures` | 鉅額交易各商品成交資訊-期貨 |
