---
github_issue: N/A
title: 新增工具 get_otc_foreign_trading（上櫃外資及陸資買賣超彙總）
type: feature
priority: high
status: done
depends_on: []
...
# T197 - 新增工具 get_otc_foreign_trading（上櫃外資及陸資買賣超彙總）

## 目標
查詢上櫃股票外資及陸資每日買賣超彙總。對稱上市 T86；現有 get_institutional_investors 上櫃僅合計，本工具提供外資細項。
