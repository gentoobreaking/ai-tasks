---
github_issue: N/A
title: 新增工具 get_emp88_index（勞工就業88指數）
type: feature
priority: low
status: pending
depends_on: []
...
# T220 - 新增工具 get_emp88_index（勞工就業88指數）

## 目標
查詢勞工就業88指數歷史/當日收盤與成分股。
...
| 端點 | 說明 |
|---|---|
| `tpex_emp88_reward_index` | 勞工就業88指數歷史收盤指數 |
| `tpex_emp88_change` | 勞工就業88指數當日收盤指數 |
| `tpex_emp88_constituents` | 勞工就業88指數當日成分股 |
