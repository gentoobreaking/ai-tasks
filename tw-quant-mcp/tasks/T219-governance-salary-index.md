---
github_issue: N/A
title: 新增工具 get_governance_salary_index（公司治理/薪酬指數）
type: feature
priority: low
status: pending
depends_on: []
...
# T219 - 新增工具 get_governance_salary_index（公司治理/薪酬指數）

## 目標
查詢上櫃公司治理指數與薪酬指數（family 參數 governance/salary；view latest/constituents）。
