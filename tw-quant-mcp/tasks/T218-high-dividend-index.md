---
github_issue: N/A
title: 新增工具 get_high_dividend_index（櫃買高殖利率指數）
type: feature
priority: high
status: done
depends_on: []
...
# T218 - 新增工具 get_high_dividend_index（櫃買高殖利率指數）

## 目標
查詢櫃買高殖利率指數歷史/當日收盤與成分股。成分股即官方篩選之高殖利率組合，對 screen_high_yield 使用者直接有用。
...
| `tphd_change` | 高殖利率指數當日收盤指數 |
| `tphd_constituents` | 高殖利率指數當日成分股 |
