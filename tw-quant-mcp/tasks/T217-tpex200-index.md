---
github_issue: N/A
title: 新增工具 get_tpex200_index（富櫃50/富櫃200 指數）
type: feature
priority: medium
status: done
depends_on: []
...
# T217 - 新增工具 get_tpex200_index（富櫃50/富櫃200 指數）

## 目標
查詢富櫃50/200 指數歷史收盤、當日收盤與成分股。family 參數 tpex50/tpex200；view 參數 history/latest/constituents。
