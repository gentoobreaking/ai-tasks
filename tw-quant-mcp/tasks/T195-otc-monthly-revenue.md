---
github_issue: N/A
title: 新增工具 get_otc_monthly_revenue（上櫃月營收彙總）
type: feature
priority: high
status: pending
depends_on: []
...
# T195 - 新增工具 get_otc_monthly_revenue（上櫃月營收彙總）

## 目標
查詢上櫃公司每月營業收入彙總（code 過濾單一公司；年月、YoY/MoM 欄位）。對稱上市版 get_monthly_revenue，補齊找買點管線的上櫃基本面覆蓋。
