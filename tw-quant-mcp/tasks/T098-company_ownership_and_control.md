---
github_issue: N/A
title: 新增工具 get_company_ownership_and_control（公司治理與內部人）
type: feature
priority: medium
status: done
depends_on: ["T008"]
...
# T098 - 新增工具 `get_company_ownership_and_control`（公司治理與內部人）

## 目標
對齊線上遠端 MCP（TWSEMCPServer）的同名工具，於本機 tw-quant-mcp 新增 `get_company_ownership_and_control`，
提供「根據股票代號查詢上市公司持股及控制力資訊。」之查詢能力。工具名稱**沿用遠端命名**以利對照。
...
## 驗收標準
- [x] `tools/list` 可見 `get_company_ownership_and_control`，inputSchema 與本任務附帶者語意一致
