...
# T061 - 新增工具 `get_companies_with_csr_reports_103`（ESG 揭露細項）

## 目標
對齊線上遠端 MCP（TWSEMCPServer）的同名工具，於本機 tw-quant-mcp 新增 `get_companies_with_csr_reports_103`，
提供「查詢民國103年應編製及申報企業社會責任報告書之公司。」之查詢能力。工具名稱**沿用遠端命名**以利對照。
