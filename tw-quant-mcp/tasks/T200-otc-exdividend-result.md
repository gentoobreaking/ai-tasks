---
github_issue: N/A
title: 新增工具 get_otc_exdividend_result（上櫃除權息計算結果）
type: feature
priority: high
status: done
depends_on: []
...
# T200 - 新增工具 get_otc_exdividend_result（上櫃除權息計算結果）

## 目標
查詢上櫃除權息「計算結果」（已生效之實際數據）。現有 get_exdividend_calendar 僅預告表，本工具提供事後結果，供配息追蹤與殖利率回算。
