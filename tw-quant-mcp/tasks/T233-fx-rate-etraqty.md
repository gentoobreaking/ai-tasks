---
github_issue: N/A
title: 新增工具 get_fx_rate/e_trade_qty（外幣匯率與電子式交易統計）
type: feature
priority: low
status: pending
depends_on: []
...
# T233 - 新增工具 get_fx_rate/e_trade_qty（外幣匯率與電子式交易統計）

## 目標
查詢 TAIFEX 每日外幣參考匯率與每月電子式交易下單統計。
...
| 端點 | 說明 |
|---|---|
| `DailyForeignExchangeRates` | 每日外幣參考匯率 |
| `eTradeQty` | 每月市場電子式交易下單統計 |
