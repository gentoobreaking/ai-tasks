---
github_issue: N/A
title: 新增工具 get_otc_active_broker_volume（上櫃熱門股券商進出排行）
type: feature
priority: high
status: pending
depends_on: []
...
# T196 - 新增工具 get_otc_active_broker_volume（上櫃熱門股券商進出排行）

## 目標
查詢上櫃熱門股票之各券商分公司買賣進出排行（分點籌碼分析核心資料；stock_no 必填選定標的，回傳各券商買進/賣出張數）。連上市版都沒有此類工具，屬全新能力。
