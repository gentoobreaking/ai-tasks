---
github_issue: N/A
title: 新增工具 get_otc_warrant_daily/basic（上櫃權證行情與基本資料）
type: feature
priority: medium
status: done
depends_on: []
...
# T221 - 新增工具 get_otc_warrant_daily/basic（上櫃權證行情與基本資料）

## 目標
查詢上櫃權證收盤行情與發行基本資料。對稱上市 get_warrant_basic_info（T187）/get_warrant_activity。
