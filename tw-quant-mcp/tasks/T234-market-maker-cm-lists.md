---
github_issue: N/A
title: 新增工具 get_market_maker_cm_lists（造市者與結算會員名冊）
type: feature
priority: low
status: pending
depends_on: []
...
# T234 - 新增工具 get_market_maker_cm_lists（造市者與結算會員名冊）

## 目標
查詢期貨/選擇權造市者與結算會員、結算銀行名冊（kind 參數 mm_fut/mm_opt/cm/bank）。
