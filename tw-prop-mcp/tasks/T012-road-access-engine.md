...
## 驗收標準
- [x] 實作 Road Segment 模型與 Repository (road_id, name, road_class, width, geometry, source, source_version)
- [x] 實作 ParcelRoadAccess 模型 (parcel_id, road_id, distance_m, nearest_point, road_width_m, access_type, source, algorithm_version)
- [x] 實作最近道路查詢：ST_DWithin + ST_Distance
- [x] 實作臨路判定演算法：
...
- [x] 四種 case (ROAD_ADJACENT, ROAD_NEARBY, NO_ROAD_DETECTED, UNKNOWN) 皆有測試案例
- [x] 禁止從衛星圖「猜」道路寬度當成官方資料
