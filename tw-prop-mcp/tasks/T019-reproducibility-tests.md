...
## 驗收標準
- [x] 執行 Query A → 取得 result hash = X
- [x] 重新執行 Query A → 必須 result hash = X
- [x] 測試涵蓋：Transaction 查詢、Parcel 查詢、Comparable 查詢、GIS 查詢、Valuation 查詢
- [x] 驗證 query_hash 機制正確性
- [x] 測試不同 snapshot 版本下的查詢結果差異可預期
- [x] 自動化測試腳本可在 CI/CD 執行
