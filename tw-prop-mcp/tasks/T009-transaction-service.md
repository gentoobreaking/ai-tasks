...
## 驗收標準
- [x] 實作 TransactionService：SearchTransactions, GetTransaction, GetTransactionStatistics
- [x] 輸入參數驗證與轉換 (避免 SQL injection，符合 AI Isolation)
- [x] 回傳格式符合 MCP API 規格：包含 data, metadata(algorithm_version, snapshot_id, generated_at, query_hash), data_provenance
