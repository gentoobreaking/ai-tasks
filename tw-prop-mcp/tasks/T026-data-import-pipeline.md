...
## 驗收標準
- [x] 整合 Downloader + Parser + Normalizer + Validator 完整流程
- [x] 實作 Deduplicate：同一 snapshot 內 source_record_hash 去重
- [x] 實作 Import：批次寫入 transaction, transaction_land, transaction_building, parcel
