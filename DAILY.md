...
| 專案 | 任務 | 標題 |
| -- | -- | -- |
| tw-prop-mcp | [T001-repository-bootstrap](https://github.com/gentoobreaking/ai-tasks/blob/main/tw-prop-mcp/tasks/T001-repository-bootstrap.md) | Repository Bootstrap |
| tw-prop-mcp | [T002-postgresql-postgis-setup](https://github.com/gentoobreaking/ai-tasks/blob/main/tw-prop-mcp/tasks/T002-postgresql-postgis-setup.md) | PostgreSQL + PostGIS Setup |
| tw-prop-mcp | [T003-snapshot-model](https://github.com/gentoobreaking/ai-tasks/blob/main/tw-prop-mcp/tasks/T003-snapshot-model.md) | Snapshot Model Implementation |
| tw-prop-mcp | [T004-official-data-downloader](https://github.com/gentoobreaking/ai-tasks/blob/main/tw-prop-mcp/tasks/T004-official-data-downloader.md) | Official Data Downloader |
...
| tw-prop-mcp | [T015-valuation-engine](https://github.com/gentoobreaking/ai-tasks/blob/main/tw-prop-mcp/tasks/T015-valuation-engine.md) | Valuation Engine | high |
| tw-prop-mcp | [T016-provenance-system](https://github.com/gentoobreaking/ai-tasks/blob/main/tw-prop-mcp/tasks/T016-provenance-system.md) | Provenance System | high |
| tw-prop-mcp | [T017-mcp-server](https://github.com/gentoobreaking/ai-tasks/blob/main/tw-prop-mcp/tasks/T017-mcp-server.md) | MCP Server Implementation | high |
| tw-prop-mcp | [T018-mcp-contract-tests](https://github.com/gentoobreaking/ai-tasks/blob/main/tw-prop-mcp/tasks/T018-mcp-contract-tests.md) | MCP Contract Tests | high |
| tw-prop-mcp | [T019-reproducibility-tests](https://github.com/gentoobreaking/ai-tasks/blob/main/tw-prop-mcp/tasks/T019-reproducibility-tests.md) | Reproducibility Tests | high |
| tw-prop-mcp | [T020-artifact-lock-tests](https://github.com/gentoobreaking/ai-tasks/blob/main/tw-prop-mcp/tasks/T020-artifact-lock-tests.md) | Artifact Lock Tests | high |
...
| tw-prop-mcp | [T023-k8s-deployment](https://github.com/gentoobreaking/ai-tasks/blob/main/tw-prop-mcp/tasks/T023-k8s-deployment.md) | Kubernetes / OpenShift Deployment | medium |
| tw-prop-mcp | [T024-observability](https://github.com/gentoobreaking/ai-tasks/blob/main/tw-prop-mcp/tasks/T024-observability.md) | Observability Implementation | medium |
